...
//#endregion
//#region node_modules/chain-function/index.js
var require_chain_function = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/warning/browser.js
/**
...
//#endregion
//#region node_modules/@bkrem/react-transition-group/utils/ChildMapping.js
	...
	*/
	function mergeChildMappings(prev, next) {
		...
		function getValueForKey(key) {
			if (next.hasOwnProperty(key)) return next[key];
			return prev[key];
		}
		var nextKeysPending = {};
		var pendingKeys = [];
		for (var prevKey in prev) if (next.hasOwnProperty(prevKey)) {
...
//#endregion
//#region node_modules/@bkrem/react-transition-group/TransitionGroup.js
var require_TransitionGroup = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var _chainFunction2 = _interopRequireDefault(require_chain_function());
	var _react2 = _interopRequireDefault(require_react());
	var _propTypes2 = _interopRequireDefault(require_prop_types());
	var _warning2 = _interopRequireDefault(require_browser());
	...
	var TransitionGroup = function(_React$Component) {
		...
		function TransitionGroup(props, context) {
			...
			_this.performAppear = function(key, component) {
				...
				if (component.componentWillAppear) component.componentWillAppear(_this._handleDoneAppearing.bind(_this, key, component));
				else _this._handleDoneAppearing(key, component);
			};
			_this._handleDoneAppearing = function(key, component) {
				if (component && component.componentDidAppear) component.componentDidAppear();
				delete _this.currentlyTransitioningKeys[key];
				var currentChildMapping = (0, _ChildMapping.getChildMapping)(_this.props.children);
				if (!currentChildMapping || !currentChildMapping.hasOwnProperty(key)) _this.performLeave(key, component);
			};
			_this.performEnter = function(key, component) {
				_this.currentlyTransitioningKeys[key] = true;
				if (component.componentWillEnter) component.componentWillEnter(_this._handleDoneEntering.bind(_this, key, component));
				else _this._handleDoneEntering(key, component);
			};
			...
			_this.performLeave = function(key, component) {
				_this.currentlyTransitioningKeys[key] = true;
				if (component && component.componentWillLeave) component.componentWillLeave(_this._handleDoneLeaving.bind(_this, key, component));
				else _this._handleDoneLeaving(key, component);
			};
			_this._handleDoneLeaving = function(key, component) {
				if (component && component.componentDidLeave) component.componentDidLeave();
				delete _this.currentlyTransitioningKeys[key];
				var currentChildMapping = (0, _ChildMapping.getChildMapping)(_this.props.children);
				if (currentChildMapping && currentChildMapping.hasOwnProperty(key)) _this.keysToEnter.push(key);
		...
		TransitionGroup.prototype.componentDidMount = function componentDidMount() {
			...
			for (var key in initialChildMapping) if (initialChildMapping[key]) this.performAppear(key, this.childRefs[key]);
		};
		TransitionGroup.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
			...
			return { children: (0, _ChildMapping.mergeChildMappings)(prevChildMapping, nextChildMapping) };
		};
		TransitionGroup.prototype.componentDidUpdate = function componentDidUpdate(prevProps, prevState) {
			...
			for (var key in nextChildMapping) {
				...
				if (nextChildMapping[key] && !hasPrev && !this.currentlyTransitioningKeys[key]) this.keysToEnter.push(key);
			}
			for (var _key in prevChildMapping) {
				var hasNext = nextChildMapping && nextChildMapping.hasOwnProperty(_key);
				if (prevChildMapping[_key] && !hasNext && !this.currentlyTransitioningKeys[_key]) this.keysToLeave.push(_key);
			}
		...
		TransitionGroup.prototype.render = function render() {
			...
			var _loop = function _loop(key) {
				...
				if (child) {
					...
					if (factoryChild === child && isCallbackRef) ref = (0, _chainFunction2.default)(child.ref, ref);
...
//#endregion
//#region node_modules/dom-helpers/class/hasClass.js
...
//#endregion
//#region node_modules/dom-helpers/class/addClass.js
...
//#endregion
//#region node_modules/dom-helpers/class/removeClass.js
...
//#endregion
//#region node_modules/dom-helpers/util/inDOM.js
var require_inDOM = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	exports.__esModule = true;
...
//#endregion
//#region node_modules/dom-helpers/util/requestAnimationFrame.js
var require_requestAnimationFrame = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var _interopRequireDefault = require_interopRequireDefault();
	exports.__esModule = true;
	exports.default = void 0;
	...
	if (_inDOM.default) vendors.some(function(vendor) {
...
//#endregion
//#region node_modules/dom-helpers/transition/properties.js
...
//#endregion
//#region node_modules/@bkrem/react-transition-group/utils/PropTypes.js
var require_PropTypes = /* @__PURE__ */ __commonJSMin(((exports) => {
	exports.__esModule = true;
	exports.nameShape = void 0;
	exports.transitionTimeout = transitionTimeout;
	_interopRequireDefault(require_react());
	var _propTypes2 = _interopRequireDefault(require_prop_types());
	function _interopRequireDefault(obj) {
		return obj && obj.__esModule ? obj : { default: obj };
	}
	function transitionTimeout(transitionType) {
		...
		return function(props) {
			if (props[enabledPropName]) {
				if (props[timeoutPropName] == null) return /* @__PURE__ */ new Error(timeoutPropName + " wasn't supplied to CSSTransitionGroup: this can cause unreliable animations and won't be supported in a future version of React. See https://fb.me/react-animation-transition-group-timeout for more information.");
				else if (typeof props[timeoutPropName] !== "number") return /* @__PURE__ */ new Error(timeoutPropName + " must be a number (in milliseconds)");
			}
			return null;
		};
	}
...
//#endregion
//#region node_modules/@bkrem/react-transition-group/CSSTransitionGroupChild.js
var require_CSSTransitionGroupChild = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	exports.__esModule = true;
	var _extends = Object.assign || function(target) {
		for (var i = 1; i < arguments.length; i++) {
			var source = arguments[i];
	...
	var _removeClass2 = _interopRequireDefault(require_removeClass());
	var _requestAnimationFrame2 = _interopRequireDefault(require_requestAnimationFrame());
	...
	var CSSTransitionGroupChild = function(_React$Component) {
		...
		function CSSTransitionGroupChild(props, context) {
			...
			_this.componentWillAppear = function(done) {
				if (_this.props.appear) _this.transition("appear", done, _this.props.appearTimeout);
				else done();
			};
			_this.componentWillEnter = function(done) {
				if (_this.props.enter) _this.transition("enter", done, _this.props.enterTimeout);
				else done();
			};
			_this.componentWillLeave = function(done) {
				if (_this.props.leave) _this.transition("leave", done, _this.props.leaveTimeout);
				else done();
			};
		...
		CSSTransitionGroupChild.prototype.transition = function transition(animationType, finishCallback, timeout) {
			...
			} else if (_properties.transitionEnd) removeListeners = addEndListener(node, finish);
		};
		CSSTransitionGroupChild.prototype.queueClassAndNode = function queueClassAndNode(className, node) {
			...
			if (!this.rafHandle) this.rafHandle = (0, _requestAnimationFrame2.default)(function() {
				return _this2.flushClassNameAndNodeQueue();
			});
		};
		CSSTransitionGroupChild.prototype.flushClassNameAndNodeQueue = function flushClassNameAndNodeQueue() {
			if (!this.unmounted) this.classNameAndNodeQueue.forEach(function(obj) {
				obj.node.scrollTop;
...
//#endregion
//#region node_modules/@bkrem/react-transition-group/CSSTransitionGroup.js
var require_CSSTransitionGroup = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	exports.__esModule = true;
	var _extends = Object.assign || function(target) {
		for (var i = 1; i < arguments.length; i++) {
			var source = arguments[i];
	...
	var _react2 = _interopRequireDefault(require_react());
	var _propTypes2 = _interopRequireDefault(require_prop_types());
	var _TransitionGroup2 = _interopRequireDefault(require_TransitionGroup());
	var _CSSTransitionGroupChild2 = _interopRequireDefault(require_CSSTransitionGroupChild());
	var _PropTypes = require_PropTypes();
	function _interopRequireDefault(obj) {
		return obj && obj.__esModule ? obj : { default: obj };
	}
...
//#endregion
//#region node_modules/@bkrem/react-transition-group/index.js
var require_react_transition_group = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var _CSSTransitionGroup2 = _interopRequireDefault(require_CSSTransitionGroup());
	var _TransitionGroup2 = _interopRequireDefault(require_TransitionGroup());
	function _interopRequireDefault(obj) {
		return obj && obj.__esModule ? obj : { default: obj };
	}
...
//#endregion
//#region node_modules/react-d3-tree/lib/esm/Tree/TransitionGroupWrapper.js
var import_clone = /* @__PURE__ */ __toESM(require_clone(), 1);
var import_react_transition_group = require_react_transition_group();
var TransitionGroupWrapper = (props) => props.enableLegacyTransitions ? import_react.createElement(import_react_transition_group.TransitionGroup, {
	component: props.component,
	className: props.className,
	transform: props.transform
}, props.children) : import_react.createElement("g", {
	className: props.className,
	transform: props.transform
}, props.children);
//#endregion
//#region node_modules/react-d3-tree/lib/esm/Node/DefaultNodeElement.js
...
var DefaultNodeElement = ({ nodeDatum, toggleNode, onNodeClick, onNodeMouseOver, onNodeMouseOut }) => import_react.createElement(import_react.Fragment, null, import_react.createElement("circle", {
...
}), import_react.createElement("g", { className: "rd3t-label" }, import_react.createElement("text", Object.assign({ className: "rd3t-label__title" }, textLayout.title), nodeDatum.name), import_react.createElement("text", { className: "rd3t-label__attributes" }, nodeDatum.attributes && Object.entries(nodeDatum.attributes).map(([labelKey, labelValue], i) => import_react.createElement("tspan", Object.assign({ key: `${labelKey}-${i}` }, textLayout.attribute), labelKey, ": ", typeof labelValue === "boolean" ? labelValue.toString() : labelValue)))));
//#endregion
//#region node_modules/react-d3-tree/lib/esm/Node/index.js
var Node = class extends import_react.Component {
	constructor() {
		super(...arguments);
		this.nodeRef = null;
		this.state = {
		...
		this.renderNodeElement = () => {
			...
			return (typeof renderCustomNodeElement === "function" ? renderCustomNodeElement : DefaultNodeElement)({
				hierarchyPointNode,
				nodeDatum: data,
	...
	applyTransform(transform, transitionDuration, opacity = 1, done = () => {}) {
		if (this.props.enableLegacyTransitions) select_default$1(this.nodeRef).transition().duration(transitionDuration).attr("transform", transform).style("opacity", opacity).on("end", done);
		else {
			select_default$1(this.nodeRef).attr("transform", transform).style("opacity", opacity);
			done();
		}
	}
	commitTransform() {
...
//#endregion
//#region node_modules/react-d3-tree/lib/esm/Link/index.js
var Link = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		this.linkRef = null;
		this.state = { initialStyle: { opacity: 0 } };
		this.handleOnClick = (evt) => {
	...
	applyOpacity(opacity, transitionDuration, done = () => {}) {
		if (this.props.enableLegacyTransitions) select_default$1(this.linkRef).transition().duration(transitionDuration).style("opacity", opacity).on("end", done);
		else {
			select_default$1(this.linkRef).style("opacity", opacity);
			done();
		}
	}
	...
	drawPath() {
		...
		if (typeof pathFunc === "function") return pathFunc(linkData, orientation);
		if (pathFunc === "elbow") return this.drawElbowPath(linkData, orientation);
		if (pathFunc === "straight") return this.drawStraightPath(linkData, orientation);
		if (pathFunc === "step") return this.drawStepPath(linkData, orientation);
	...
	getClassNames() {
		...
		if (typeof pathClassFunc === "function") classNames.push(pathClassFunc(linkData, orientation));
...
//#endregion
//#region node_modules/react-d3-tree/lib/esm/globalCss.js
...
`;
//#endregion
//#region node_modules/react-d3-tree/lib/esm/Tree/index.js
var Tree = class Tree extends import_react.Component {
	constructor() {
		super(...arguments);
		this.state = {
			dataRef: this.props.data,
			data: Tree.assignInternalProperties((0, import_clone.default)(this.props.data)),
		...
		*/
		this.handleNodeToggle = (nodeId) => {
			...
			const targetNodeDatum = this.findNodesById(nodeId, data, [])[0];
			if (this.props.collapsible && !this.state.isTransitioning) {
				...
				} else Tree.collapseNode(targetNodeDatum);
		...
		this.handleAddChildrenToNode = (nodeId, childrenData) => {
			...
			if (matches.length > 0) {
				...
				const formattedChildren = (0, import_clone.default)(childrenData).map((node) => Tree.assignInternalProperties([node], depth + 1));
		...
		*/
		this.handleOnLinkClickCb = (linkSource, linkTarget, evt) => {
			...
			if (onLinkClick && typeof onLinkClick === "function") {
				evt.persist();
				onLinkClick((0, import_clone.default)(linkSource), (0, import_clone.default)(linkTarget), evt);
			}
		};
		/**
		...
		*/
		this.handleOnLinkMouseOverCb = (linkSource, linkTarget, evt) => {
			...
			if (onLinkMouseOver && typeof onLinkMouseOver === "function") {
				evt.persist();
				onLinkMouseOver((0, import_clone.default)(linkSource), (0, import_clone.default)(linkTarget), evt);
			}
		};
		/**
		...
		*/
		this.handleOnLinkMouseOutCb = (linkSource, linkTarget, evt) => {
			...
			if (onLinkMouseOut && typeof onLinkMouseOut === "function") {
				evt.persist();
				onLinkMouseOut((0, import_clone.default)(linkSource), (0, import_clone.default)(linkTarget), evt);
			}
		};
		/**
		...
		*/
		this.centerNode = (hierarchyPointNode) => {
			...
			if (dimensions) {
				const g = select_default$1(`.${this.gInstanceRef}`);
				const svg = select_default$1(`.${this.svgInstanceRef}`);
				...
				svg.call(zoom_default().transform, identity.translate(x, y).scale(zoom));
			}
		};
		/**
		...
		*/
		this.getNodeClassName = (parent, nodeDatum) => {
			...
			if (parent !== null && parent !== void 0) return nodeDatum.children ? branchNodeClassName : leafNodeClassName;
			else return rootNodeClassName;
		};
	}
	static getDerivedStateFromProps(nextProps, prevState) {
		let derivedState = null;
		const dataKeyChanged = !nextProps.dataKey || prevState.dataKey !== nextProps.dataKey;
		if (nextProps.data !== prevState.dataRef && dataKeyChanged) derivedState = {
			dataRef: nextProps.data,
			data: Tree.assignInternalProperties((0, import_clone.default)(nextProps.data)),
			isInitialRenderForDataset: true,
	...
	componentDidUpdate(prevProps) {
		if (this.props.data !== prevProps.data) this.setState({ isInitialRenderForDataset: false });
		if (!dequal(this.props.translate, prevProps.translate) || !dequal(this.props.scaleExtent, prevProps.scaleExtent) || this.props.zoomable !== prevProps.zoomable || this.props.draggable !== prevProps.draggable || this.props.zoom !== prevProps.zoom || this.props.enableLegacyTransitions !== prevProps.enableLegacyTransitions) this.bindZoomListener(this.props);
	...
	bindZoomListener(props) {
		...
		svg.call(zoom_default().scaleExtent(zoomable ? [scaleExtent.min, scaleExtent.max] : [zoom, zoom]).filter((event) => {
			...
			if (!this.props.draggable && [
				...
				"touchmove",
				"dblclick"
			].includes(event.sourceEvent.type)) return;
	...
	*/
	static assignInternalProperties(data, currentDepth = 0) {
		return (Array.isArray(data) ? data : [data]).map((n) => {
			const nodeDatum = n;
			nodeDatum.__rd3t = {
				id: null,
				depth: null,
			...
			if (nodeDatum.children && nodeDatum.children.length > 0) nodeDatum.children = Tree.assignInternalProperties(nodeDatum.children, currentDepth + 1);
			return nodeDatum;
		});
	}
	/**
	...
	*/
	findNodesById(nodeId, nodeSet, hits) {
		...
		nodeSet.forEach((node) => {
			if (node.children && node.children.length > 0) hits = this.findNodesById(nodeId, node.children, hits);
		});
		return hits;
	}
	/**
	...
	*/
	findNodesAtDepth(depth, nodeSet, accumulator) {
		...
		nodeSet.forEach((node) => {
			if (node.children && node.children.length > 0) accumulator = this.findNodesAtDepth(depth, node.children, accumulator);
		});
		return accumulator;
	}
	/**
	...
	*/
	static collapseNode(nodeDatum) {
		...
		if (nodeDatum.children && nodeDatum.children.length > 0) nodeDatum.children.forEach((child) => {
	...
	*/
	collapseNeighborNodes(targetNode, nodeSet) {
		this.findNodesAtDepth(targetNode.__rd3t.depth, nodeSet, []).filter((node) => node.__rd3t.id !== targetNode.__rd3t.id).forEach((neighbor) => Tree.collapseNode(neighbor));
	}
	/**
	...
	*/
	generateTree() {
		...
		const rootNode = tree_default().nodeSize(orientation === "horizontal" ? [nodeSize.y, nodeSize.x] : [nodeSize.x, nodeSize.y]).separation((a, b) => a.parent.data.__rd3t.id === b.parent.data.__rd3t.id ? separation.siblings : separation.nonSiblings)(hierarchy(this.state.data[0], (d) => d.__rd3t.collapsed ? null : d.children));
		let nodes = rootNode.descendants();
		const links = rootNode.links();
		if (initialDepth !== void 0 && isInitialRenderForDataset) this.setInitialTreeDepth(nodes, initialDepth);
		if (depthFactor) nodes.forEach((node) => {
	...
	*/
	static calculateD3Geometry(nextProps) {
		let scale;
		if (nextProps.zoom > nextProps.scaleExtent.max) scale = nextProps.scaleExtent.max;
		else if (nextProps.zoom < nextProps.scaleExtent.min) scale = nextProps.scaleExtent.min;
		else scale = nextProps.zoom;
		return {
	...
	render() {
		...
		return import_react.createElement("div", { className: "rd3t-tree-container rd3t-grabbable" }, import_react.createElement("style", null, globalCss_default), import_react.createElement("svg", {
			className: `rd3t-svg ${this.svgInstanceRef} ${svgClassName}`,
			width: "100%",
			height: "100%"
		}, import_react.createElement(TransitionGroupWrapper, {
			...
			return import_react.createElement(Node, {
				key: "node-" + i,
				data,
				position: {
					x,
...
//#endregion
//#region node_modules/react-d3-tree/lib/esm/index.js
var esm_default = Tree;
//#endregion
export { Tree, esm_default as default };
